...
t.describe('format-diff', () => {
    ...
    t.test.each([
        ...
        {description: 'empty array -> array', a: [], b: [1], expected: '[\n  0: 1\n]'},
        {description: 'array -> empty array', a: [1], b: [], expected: '[\n  0: 1\n]'},
        {description: 'undefined field -> number field', a: {foo: undefined}, b: {foo: 1}, expected: '{\n  foo: 1\n}'},
        {description: 'number field -> undefined field', a: {foo: 1}, b: {foo: undefined}, expected: '{\n  foo: 1\n}'},
